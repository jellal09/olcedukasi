...
class Academic extends CI_Controller {
    ...
    {
        parent::__construct();
       $this->load->model('AcademiClass_model');
    ...
    //    $testimoni   = $this->testimoni_model->testimoni() ;
        ...
        $data = array(  'title'     => 'AcademiClass - '.$site->namaweb,
                        'deskripsi' => 'AcademiClass- '.$site->namaweb,
                        'keywords'  => 'AcademiClass - '.$site->namaweb,
                    //    'testimoni'  => $testimoni,
                        'site'      => $site,
                        'isi'       => 'daftar/academiclass');
