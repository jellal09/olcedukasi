...
class Psiko extends CI_Controller {

    // Load database
    public function __construct()
    {
        parent::__construct();
       $this->load->model('PsikoClass_model');
    ...
    //    $testimoni   = $this->testimoni_model->testimoni() ;
        ...
        $data = array(  'title'     => 'PsikoClass - '.$site->namaweb,
                        'deskripsi' => 'PsikoClass- '.$site->namaweb,
                        'keywords'  => 'PsikoClass - '.$site->namaweb,
                    //    'testimoni'  => $testimoni,
                        'site'      => $site,
                        'isi'       => 'daftar/psikoclass');
