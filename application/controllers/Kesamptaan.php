...
class Kesamptaan extends CI_Controller {

    // Load database
    public function __construct()
    {
        parent::__construct();
       $this->load->model('KesamptaanClass_model');
    ...
    //    $testimoni   = $this->testimoni_model->testimoni() ;
        ...
        $data = array(  'title'     => 'KesamptaanClass - '.$site->namaweb,
                        'deskripsi' => 'KesamptaanClass- '.$site->namaweb,
                        'keywords'  => 'KesamptaanClass- '.$site->namaweb,
                    //    'testimoni'  => $testimoni,
                        'site'      => $site,
                        'isi'       => 'daftar/kesamptaanclass');
