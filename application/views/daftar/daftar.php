      ...
      <div class="row">
        <div class="contact-us">
          <div class="row">
            ...
            <div class="col-md-8">
              <h3 class="contact-title">Formulir Pendaftaran Online</h3>
              <hr>
              ...
              <form id="whatsapp" class="contact-form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div> No WA</div>
                      <input type="text" class="form-control nowhatsapp" id="nowhatsapp" name="nowhatsaap"
                ...
                <div class="col-md-6">
                  <div class="form-group" style="margin-left: -12px">
                    ...
                    <select class="form-control kelas">
                      ...
                      <option class="select-option kelas" value="Paket Platinum" class="select-option">Paket Platinum
                      </option>
                      ...
                      <option class="select-option kelas" value="Paket Intensive" class="select-option">Paket Intensive
                      </option>
            ...
            <div class="col-md-4">
              ...
              <br><br><br>
              <!-- .contact-address -->
              <img src="<?php echo base_url(); ?>assets/images/banner1.jpeg">
              <hr>
            </div>
            <!-- .col-md-4 -->
          </div>
  ...
  <script>
    ...
    function WhatsApp() {
      ...
      if ($('#whatsapp .nama').val() == '') { // Cek Nama
        ...
        $(this).attr('href', url_wa + '?phone=62 ' + tujuan + '&text=Saya mau daftar %0A%0ANama: ' + nama + ' %0ANo. Whatsapp: ' + nowhatsapp + '%0Aemail: ' + email + '%0AAlamat: ' + alamat + '%0AProgram: ' + kelas + '%0AKelas: ' + minat + ' %0A%0Avia ' + via_url);
        var w = 960,
          h = 540,
