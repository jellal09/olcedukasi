 ...
 <section class="bg-contact-us" style="background: #f7f7f7">
            <div class="container">
                <div class="row">
                    <div class="contact-us">
                        <div class="row">
                            <div class="col-md-8">
                                <h3 class="contact-title">Daftar Psiko Class</h3>
                                <hr>
          ...
          <div class="btn btn-default">
            <a class="submit">Kirim</a>
                            ...
                            <div class="col-md-4">
                               ...
                               <br><br><br>
                                <!-- .contact-address -->
                               <img src="<?php echo base_url();?>assets/images/psiko-class.jpeg">
                            </div>
                            <!-- .col-md-4 -->
                        </div>
                        <!-- .row -->
    ...
    function WhatsApp() {
      var ph = '';
        ...
        $(this).attr('href', url_wa + '?phone=62 ' + tujuan + '&text=Saya mau daftar layanan OLC EDUKASI %0A%0ANama: ' + nama + ' %0ANo. Whatsapp: ' + nowhatsapp + '%0Aemail: '+ email + '%0AAlamat: ' + alamat + '%0AProgram: ' + kelas + '%0AKelas: ' + minat + ' %0A%0Avia ' + via_url);
        var w = 960,
          h = 540,
